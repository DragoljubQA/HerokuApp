...
public class herokuappLoginPageDDT extends baseHerokuappDDT {

    ExcelReader citacIzExcela;

    public herokuappLoginPageDDT(){
    ...
    public void clickLogin() {Button.click();}
    ...
    public String usernameTitle() {return UsernameTitle.getText();}
